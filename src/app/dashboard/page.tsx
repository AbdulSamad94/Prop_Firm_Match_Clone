        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              <h3 className="text-lg font-medium text-purple-800">Upcoming Events</h3>
          ...
          <div className="mt-8">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-blue-500 pl-4 py-2 bg-gray-50">
                <p className="text-sm text-gray-600">Created new project "Website Redesign"</p>
                <p className="text-xs text-gray-500 mt-1">2 hours ago</p>
              </div>
              <div className="border-l-4 border-green-500 pl-4 py-2 bg-gray-50">
                <p className="text-sm text-gray-600">Completed task "Homepage Layout"</p>
